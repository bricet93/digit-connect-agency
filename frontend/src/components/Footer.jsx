      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-800/80">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="p-2.5 bg-slate-800 hover:bg-slate-300 text-slate-300 hover:text-slate-800 rounded-xl transition-all duration-500">
              <FaLinkedinIn />
            </a>
            <a href="https://facebook.com" target="_blank" rel="noreferrer" className="p-2.5 bg-slate-800 hover:bg-slate-300 text-slate-300 hover:text-slate-800 rounded-xl transition-all duration-500">
              <FaFacebookF />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="p-2.5 bg-slate-800 hover:bg-slate-300 text-slate-300 hover:text-slate-800 rounded-xl transition-all duration-500">
              <FaInstagram />
            </a>
          </div>
        </div>
