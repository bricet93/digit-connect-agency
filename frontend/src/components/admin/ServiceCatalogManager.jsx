  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button onClick={fetchCatalog} className="p-2 bg-slate-200 hover:bg-slate-300 rounded-xl transition-all cursor-pointer">
          <RefreshCw size={16} />
        </button>
      </div>
      ...
      <form onSubmit={handleSave} className="p-5 bg-white rounded-2xl border border-slate-200 shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="flex flex-col gap-1">
            <div className="relative">
              <input
                ...
                className={`w-full p-2.5 bg-slate-50 border rounded-xl text-xs outline-none transition-all disabled:opacity-50 ${
          ...
          <input
            ...
            className="p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs outline-none focus:border-digitBlue"
          />
          <input
            type="text"
            required
        ...
        <div className="flex gap-2 justify-end">
          {editingId && (
            <button
              ...
              className="px-4 py-2 bg-slate-100 text-slate-600 rounded-xl text-xs font-bold flex items-center gap-1 cursor-pointer"
            >
              <X size={14} /> Annuler
            </button>
          )}
          <button
            ...
            className="px-5 py-2 bg-digitBlue hover:bg-digitBlue/90 disabled:opacity-50 text-white rounded-xl text-xs font-bold flex items-center gap-1 shadow-md cursor-pointer transition-all"
          >
